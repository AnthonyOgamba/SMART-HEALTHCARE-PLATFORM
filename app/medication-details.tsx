...
const styles=StyleSheet.create({content:{padding:18,gap:16,backgroundColor:Brand.screenBg},header:{flexDirection:'row',alignItems:'center',gap:12},title:{...PageTypography.title,color:Brand.accent},hero:{backgroundColor:Brand.accent,borderRadius:16,padding:20},active:{color:'#D6E8FF',fontSize:10,fontWeight:'700'},medName:{color:'#FFF',fontSize:25,fontWeight:'700',marginTop:5},muted:{color:Brand.textSecondary,fontSize:13},card:{backgroundColor:'#FFF',borderWidth:1,borderColor:Brand.cardBorder,borderRadius:16,padding:18,gap:14},row:{borderBottomWidth:1,borderBottomColor:Brand.cardBorder,paddingBottom:10},label:{fontSize:11,color:Brand.textSecondary,fontWeight:'700'},value:{fontSize:15,color:Brand.textPrimary,marginTop:3},section:{fontSize:18,fontWeight:'700',color:Brand.accent},percent:{fontSize:30,fontWeight:'700',color:Brand.primary},note:{fontSize:11,color:Brand.textSecondary,lineHeight:16},primary:{height:52,borderRadius:12,backgroundColor:Brand.primary,alignItems:'center',justifyContent:'center'},primaryText:{color:'#FFF',fontWeight:'700'},archive:{height:50,borderWidth:1,borderColor:'#E9B9B9',borderRadius:12,flexDirection:'row',gap:8,alignItems:'center',justifyContent:'center'},archiveText:{color:'#BA1A1A',fontWeight:'700'}});
